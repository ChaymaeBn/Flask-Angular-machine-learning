...
cnn_model = tf.keras.models.load_model(
    STATIC_FOLDER + "/models/" + "dog_cat_M.h5")
...
def classifier(model, image_path):
...
def upload_file():
    ...
    if request.method == "GET":
        ...
        label, prob = classifier(cnn_model, upload_image_path)

        prob = round((prob * 100), 2)

    # return render_template(
     #   "classifier.html", image_file_name=file.filename, label=label, prob=prob
    # )
